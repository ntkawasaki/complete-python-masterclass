...
# in append mode
# with open("/Users/noahkawasaki/Desktop/Programs/Text Files/sample.txt", 'a') as tables:
#     for i in range(1, 13):
#         for j in range(1, 13):
#             print("{0:>2} times {1:>2} = {2:>3}".format(j, i, i * j), file=tables)
#         print("=" * 17, file=tables)

# test
with open("/Users/noahkawasaki/Desktop/Programs/Text Files/sample.txt", 'r') as tables:
    for line in tables:
        print(line, end="")
