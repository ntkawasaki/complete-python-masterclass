...
input_prompt = ("Please enter your IP Address. An IP address consists of 4 numbers, "
                "separated from each other with a full stop.")
ip_input = input(input_prompt)
if ip_input[-1] != ".":
    ip_input += "."
...
# unless last char is "." it will not print last segment
# if char != ".":
#     print("Segment {} contains {} characters.".format(segment, segment_length))
